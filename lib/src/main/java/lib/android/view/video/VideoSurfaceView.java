...
public abstract class VideoSurfaceView extends SurfaceView implements MediaPlayerControl, Callback {
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mAudioSession != 0) {
                mVideoPlayer.setAudioSessionId(mAudioSession);
            } else {
                mAudioSession = mVideoPlayer.getAudioSessionId();
            }
            mVideoPlayer.setDataSource(getContext(), mUri, mHeaders);
    ...
    /**
     * @param screenOn defaults true
     */
    public void setScreenOnWhilePlaying(boolean screenOn) {
        if (mScreenOnWhilePlaying != screenOn) {
            if (screenOn && mSurfaceHolder == null) {
                Logger.getDefault().d("setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    protected abstract VideoPlayer createPlayer();
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        if (mVideoPlayer != null && isValidState && hasValidSize) {
    ...
    public boolean isPlaying() {
        return isInPlaybackState() && mVideoPlayer.isPlaying();
    }
    ...
    private boolean isInPlaybackState() {
        return (mVideoPlayer != null && mCurrentState != STATE_ERROR && mCurrentState != STATE_IDLE
                && mCurrentState != STATE_PREPARING);
    }
}
